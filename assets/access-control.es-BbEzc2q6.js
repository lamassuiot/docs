...
`,e.jsxs(a.p,{children:["Continúa con ",e.jsx(a.a,{href:"/docs/platform/pki/audit-logs",children:"Registros de auditoría"})," para investigar cambios de configuración o con ",e.jsx(a.a,{href:"/docs/platform/pki/troubleshooting",children:"Resolución de problemas"})," para diagnosticar el despliegue."]})]})}function u(i={}){const{wrapper:a}=i.components||{};return a?e.jsx(a,{...i,children:e.jsx(c,{...i})}):c(i)}function o(i,a){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const m=Object.freeze(Object.defineProperty({__proto__:null,_markdown:l,default:u,frontmatter:d,structuredData:t,toc:p},Symbol.toStringTag,{value:"Module"}));export{m as _};
