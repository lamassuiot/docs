...
`,e.jsxs(t.p,{children:["In a self-managed deployment, Lamassu uses PostgreSQL for persistence, RabbitMQ for messaging and an OIDC provider for authentication. See the ",e.jsx(t.a,{href:"/docs/deployment/self-hosted/overview#architecture",children:"deployment architecture"})," for how the services are published on Kubernetes."]})]})}function d(n={}){const{wrapper:t}=n.components||{};return t?e.jsx(t,{...n,children:e.jsx(o,{...n})}):o(n)}function l(n,t){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const p=Object.freeze(Object.defineProperty({__proto__:null,_markdown:s,default:d,frontmatter:i,structuredData:r,toc:c},Symbol.toStringTag,{value:"Module"}));export{p as _};
