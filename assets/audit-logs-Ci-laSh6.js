...
`]}),`
`,e.jsxs(n.p,{children:["Para métricas, trazas y logs técnicos del despliegue, consulta ",e.jsx(n.a,{href:"/docs/platform/pki/troubleshooting",children:"Resolución de problemas"}),". La auditoría responde a “quién intentó cambiar qué”; la observabilidad explica cómo se comportó el sistema."]})]})}function m(i={}){const{wrapper:n}=i.components||{};return n?e.jsx(n,{...i,children:e.jsx(c,{...i})}):c(i)}function r(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{d as _markdown,m as default,l as frontmatter,u as structuredData,p as toc};
