...
`,c={title:"Despliega desde AWS Marketplace",description:"Ejecuta una instancia preconfigurada de Lamassu IoT en Amazon EC2."},d={contents:[{heading:void 0,content:"La oferta de AWS Marketplace reduce la preparación inicial a una instancia EC2 dentro de tu cuenta. Tú mantienes el control de la red, el almacenamiento y la operación de la máquina."},{heading:"antes-de-empezar",content:"Permisos para suscribirte a productos de AWS Marketplace y lanzar instancias EC2."},{heading:"antes-de-empezar",content:"Una VPC y una subred desde la que puedan acceder administradores y dispositivos."},{heading:"antes-de-empezar",content:"Un grupo de seguridad que permita los endpoints necesarios."},{heading:"requisitos-de-infraestructura",content:"**Cómputo:** una instancia `t3.large` como mínimo. Utiliza `t3.xlarge` o superior cuando la carga lo requiera."},{heading:"requisitos-de-infraestructura",content:"**Almacenamiento:** un volumen EBS `gp3` de al menos 50 GB, ajustado al tamaño del inventario y la retención."},{heading:"requisitos-de-infraestructura",content:"**Red:** acceso HTTPS desde los consumidores necesarios, restringido a redes de confianza."},{heading:"abre-la-oferta",content:"Accede a Lamassu IoT en AWS Marketplace y revisa las condiciones antes de suscribirte."},{heading:"configura-la-instancia",content:"Selecciona `t3.large` o superior, asigna al menos 50 GB de almacenamiento `gp3` y elige la VPC y subred de destino."},{heading:"limita-el-acceso-de-red",content:"Configura el grupo de seguridad para los puertos `443`, `8443` y `9443`. Restringe los orígenes a las redes administrativas y de dispositivos que realmente necesiten conectarse."},{heading:"lanza-y-verifica",content:"Inicia la instancia y abre la consola en `https://<ip-publica>`. Comprueba que puedes autenticarte antes de continuar."},{heading:"siguiente-paso",content:"Continúa con Crea tu primera CA para validar la configuración criptográfica de la instancia."}],headings:[{id:"antes-de-empezar",content:"Antes de empezar"},{id:"requisitos-de-infraestructura",content:"Requisitos de infraestructura"},{id:"abre-la-oferta",content:"Abre la oferta"},{id:"configura-la-instancia",content:"Configura la instancia"},{id:"limita-el-acceso-de-red",content:"Limita el acceso de red"},{id:"lanza-y-verifica",content:"Lanza y verifica"},{id:"siguiente-paso",content:"Siguiente paso"}]};const l=[{depth:2,url:"#antes-de-empezar",title:e.jsx(e.Fragment,{children:"Antes de empezar"})},{depth:2,url:"#requisitos-de-infraestructura",title:e.jsx(e.Fragment,{children:"Requisitos de infraestructura"})},{depth:3,url:"#abre-la-oferta",title:e.jsx(e.Fragment,{children:"Abre la oferta"})},{depth:3,url:"#configura-la-instancia",title:e.jsx(e.Fragment,{children:"Configura la instancia"})},{depth:3,url:"#limita-el-acceso-de-red",title:e.jsx(e.Fragment,{children:"Limita el acceso de red"})},{depth:3,url:"#lanza-y-verifica",title:e.jsx(e.Fragment,{children:"Lanza y verifica"})},{depth:2,url:"#siguiente-paso",title:e.jsx(e.Fragment,{children:"Siguiente paso"})}];function t(n){const a={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...n.components},{Step:i,Steps:r}=a;return i||s("Step"),r||s("Steps"),e.jsxs(e.Fragment,{children:[e.jsx(a.p,{children:"La oferta de AWS Marketplace reduce la preparación inicial a una instancia EC2 dentro de tu cuenta. Tú mantienes el control de la red, el almacenamiento y la operación de la máquina."}),`
...
`,e.jsxs(a.ul,{children:[`
`,e.jsxs(a.li,{children:[e.jsx(a.strong,{children:"Cómputo:"})," una instancia ",e.jsx(a.code,{children:"t3.large"})," como mínimo. Utiliza ",e.jsx(a.code,{children:"t3.xlarge"})," o superior cuando la carga lo requiera."]}),`
`,e.jsxs(a.li,{children:[e.jsx(a.strong,{children:"Almacenamiento:"})," un volumen EBS ",e.jsx(a.code,{children:"gp3"})," de al menos 50 GB, ajustado al tamaño del inventario y la retención."]}),`
`,e.jsxs(a.li,{children:[e.jsx(a.strong,{children:"Red:"})," acceso HTTPS desde los consumidores necesarios, restringido a redes de confianza."]}),`
`]}),`
...
`,e.jsxs(a.p,{children:["Continúa con ",e.jsx(a.a,{href:"/docs/platform/pki/quickstarts/create-certificate-authority",children:"Crea tu primera CA"})," para validar la configuración criptográfica de la instancia."]})]})}function u(n={}){const{wrapper:a}=n.components||{};return a?e.jsx(a,{...n,children:e.jsx(t,{...n})}):t(n)}function s(n,a){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const m=Object.freeze(Object.defineProperty({__proto__:null,_markdown:o,default:u,frontmatter:c,structuredData:d,toc:l},Symbol.toStringTag,{value:"Module"}));export{m as _};
