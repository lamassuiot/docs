...
¿Es tu primera vez? Sigue [Crea tu primera CA](/docs/manual/inicio/primera-ca) para completar el recorrido mínimo.
...
Sigue [Emite tu primer certificado](/docs/manual/inicio/primer-certificado) para el flujo guiado. La [gestión de certificados](/docs/manual/servicios-core/certificates) explica el inventario, la inspección y la revocación.
...
`]}),`
`,e.jsxs(r,{children:[e.jsxs(i,{children:[e.jsx(a.h3,{id:"abre-el-asistente",children:"Abre el asistente"}),e.jsxs(a.p,{children:["En ",e.jsx(a.strong,{children:"Certification Authorities"}),", selecciona ",e.jsx(a.strong,{children:"Create New CA"})," y elige generar un par de claves nuevo."]})]}),e.jsxs(i,{children:[e.jsx(a.h3,{id:"configura-la-clave",children:"Configura la clave"}),e.jsx(a.p,{children:"Selecciona el motor criptográfico, el algoritmo y el tamaño o curva. Lamassu admite claves RSA y EC según las capacidades del motor."}),e.jsxs(a.table,{children:[e.jsx(a.thead,{children:e.jsxs(a.tr,{children:[e.jsx(a.th,{children:"Algoritmo"}),e.jsx(a.th,{children:"Parámetros disponibles"})]})}),e.jsxs(a.tbody,{children:[e.jsxs(a.tr,{children:[e.jsx(a.td,{children:"RSA"}),e.jsx(a.td,{children:"1024, 2048, 3072 o 4096 bits"})]}),e.jsxs(a.tr,{children:[e.jsx(a.td,{children:"EC"}),e.jsx(a.td,{children:"P-256, P-384 o P-521"})]})]})]})]}),e.jsxs(i,{children:[e.jsx(a.h3,{id:"elige-el-tipo-de-ca",children:"Elige el tipo de CA"}),e.jsxs(a.p,{children:["Selecciona ",e.jsx(a.strong,{children:"Root CA"})," para una autoridad autofirmada o ",e.jsx(a.strong,{children:"Intermediate CA"})," para una autoridad firmada por otra CA. En el segundo caso, elige la CA emisora."]})]}),e.jsxs(i,{children:[e.jsx(a.h3,{id:"define-la-identidad",children:"Define la identidad"}),e.jsxs(a.p,{children:["Introduce un ",e.jsx(a.strong,{children:"CA Name"})," único. Este nombre se convierte en el ",e.jsx(a.code,{children:"Common Name"})," del certificado. Completa los campos del Distinguished Name que necesite tu política:"]}),e.jsxs(a.ul,{children:[`
...
`,e.jsxs(a.table,{children:[e.jsx(a.thead,{children:e.jsxs(a.tr,{children:[e.jsx(a.th,{children:"Método"}),e.jsx(a.th,{children:"Cuándo usarlo"}),e.jsx(a.th,{children:"Custodia de la clave"})]})}),e.jsxs(a.tbody,{children:[e.jsxs(a.tr,{children:[e.jsx(a.td,{children:e.jsx(a.strong,{children:"Generate Key & CSR in Browser"})}),e.jsx(a.td,{children:"Operación manual o prueba rápida"}),e.jsx(a.td,{children:"El navegador genera la clave; debes descargarla."})]}),e.jsxs(a.tr,{children:[e.jsx(a.td,{children:e.jsx(a.strong,{children:"Upload Existing CSR"})}),e.jsx(a.td,{children:"La clave debe permanecer en el sistema de destino"}),e.jsx(a.td,{children:"Lamassu nunca recibe la clave privada."})]})]})]}),`
`,e.jsxs(a.p,{children:["Sigue ",e.jsx(a.a,{href:"/docs/manual/inicio/primer-certificado",children:"Emite tu primer certificado"})," para el flujo guiado. La ",e.jsx(a.a,{href:"/docs/manual/servicios-core/certificates",children:"gestión de certificados"})," explica el inventario, la inspección y la revocación."]}),`
...
`,e.jsx(a.p,{children:"La eliminación permanente solo está disponible después de revocar. Elimina el registro únicamente cuando la política de retención y auditoría lo permita."})]})}function m(n={}){const{wrapper:a}=n.components||{};return a?e.jsx(a,{...n,children:e.jsx(c,{...n})}):c(n)}function t(n,a){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}export{l as _markdown,m as default,s as frontmatter,u as structuredData,p as toc};
