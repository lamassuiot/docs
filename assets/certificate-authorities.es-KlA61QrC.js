...
`,e.jsx(a.p,{children:"La eliminación permanente solo está disponible después de revocar. Elimina el registro únicamente cuando la política de retención y auditoría lo permita."})]})}function p(n={}){const{wrapper:a}=n.components||{};return a?e.jsx(a,{...n,children:e.jsx(o,{...n})}):o(n)}function t(n,a){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const f=Object.freeze(Object.defineProperty({__proto__:null,_markdown:c,default:p,frontmatter:l,structuredData:s,toc:u},Symbol.toStringTag,{value:"Module"}));export{f as _};
