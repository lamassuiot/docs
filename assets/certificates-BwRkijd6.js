...
`,e.jsx(t,{type:"warn",title:"Solo CertificateHold es reversible",children:e.jsxs(a.p,{children:["Una revocación con la razón ",e.jsx(a.code,{children:"CertificateHold"})," puede reactivarse. Las demás razones producen una revocación definitiva."]})}),`
`,e.jsx(a.h2,{id:"continúa",children:"Continúa"}),`
`,e.jsxs(o,{children:[e.jsx(c,{title:"Validar con OCSP",description:"Consulta el estado de un certificado en tiempo real.",href:"/docs/manual/servicios-core/validation-ocsp"}),e.jsx(c,{title:"Distribuir una CRL",description:"Publica el estado para validación offline.",href:"/docs/manual/servicios-core/validation-crl"})]})]})}function v(i={}){const{wrapper:a}=i.components||{};return a?e.jsx(a,{...i,children:e.jsx(s,{...i})}):s(i)}function n(i,a){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{u as _markdown,v as default,f as frontmatter,p as structuredData,m as toc};
