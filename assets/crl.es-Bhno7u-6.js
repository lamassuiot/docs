...
`]}),`
`,e.jsxs(r,{children:[e.jsx(n,{title:"Servicio OCSP",href:"/docs/platform/pki/ocsp"}),e.jsx(n,{title:"Validación de certificados",href:"/docs/platform/pki/certificate-validation"})]})]})}function p(i={}){const{wrapper:a}=i.components||{};return a?e.jsx(a,{...i,children:e.jsx(d,{...i})}):d(i)}function c(i,a){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const h=Object.freeze(Object.defineProperty({__proto__:null,_markdown:l,default:p,frontmatter:t,structuredData:s,toc:o},Symbol.toStringTag,{value:"Module"}));export{h as _};
