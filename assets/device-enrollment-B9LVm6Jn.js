...
`,e.jsxs(r,{children:[e.jsx(o,{title:"Enrolamiento EST",description:"Configura autenticación, endpoints y flujos para firmware.",href:"/docs/platform/pki/est-enrollment"}),e.jsx(o,{title:"Dispositivos e identidades",description:"Consulta estados, historial y acciones operativas.",href:"/docs/platform/pki/device-management"})]})]})}function f(i={}){const{wrapper:n}=i.components||{};return n?e.jsx(n,{...i,children:e.jsx(d,{...i})}):d(i)}function t(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{c as _markdown,f as default,p as frontmatter,u as structuredData,m as toc};
