...
`,e.jsxs(o,{children:[e.jsx(a,{title:"Configure a DMS",description:"Define the CA, trust and policies of the fleet.",href:"/docs/platform/pki/device-enrollment"}),e.jsx(a,{title:"Integrate EST",description:"Let the device request and renew its identity.",href:"/docs/platform/pki/est-enrollment"})]})]})}function p(i={}){const{wrapper:t}=i.components||{};return t?e.jsx(t,{...i,children:e.jsx(d,{...i})}):d(i)}function s(i,t){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const u=Object.freeze(Object.defineProperty({__proto__:null,_markdown:l,default:p,frontmatter:h,structuredData:v,toc:m},Symbol.toStringTag,{value:"Module"}));export{u as _};
