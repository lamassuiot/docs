...
`,e.jsxs(d,{children:[e.jsx(t,{title:"Configura un DMS",description:"Define la CA, confianza y políticas de la flota.",href:"/docs/platform/pki/device-enrollment"}),e.jsx(t,{title:"Integra EST",description:"Permite que el dispositivo solicite y renueve su identidad.",href:"/docs/platform/pki/est-enrollment"})]})]})}function m(a={}){const{wrapper:i}=a.components||{};return i?e.jsx(i,{...a,children:e.jsx(c,{...a})}):c(a)}function o(a,i){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const g=Object.freeze(Object.defineProperty({__proto__:null,_markdown:l,default:m,frontmatter:p,structuredData:u,toc:v},Symbol.toStringTag,{value:"Module"}));export{g as _};
