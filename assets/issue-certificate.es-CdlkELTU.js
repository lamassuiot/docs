...
`,e.jsxs(a.p,{children:[e.jsx(a.a,{href:"/docs/platform/pki/quickstarts/register-device",children:"Registra tu primer dispositivo"})," para asociar la identidad a una entidad gestionada, o consulta la ",e.jsx(a.a,{href:"/docs/platform/pki/certificates",children:"gestión de certificados"}),"."]})]})}function p(i={}){const{wrapper:a}=i.components||{};return a?e.jsx(a,{...i,children:e.jsx(d,{...i})}):d(i)}function r(i,a){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const g=Object.freeze(Object.defineProperty({__proto__:null,_markdown:c,default:p,frontmatter:l,structuredData:o,toc:u},Symbol.toStringTag,{value:"Module"}));export{g as _};
