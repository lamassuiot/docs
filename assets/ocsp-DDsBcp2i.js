...
`]}),`
`,e.jsxs(s,{children:[e.jsx(a,{title:"Servicio CRL",href:"/docs/platform/pki/crl"}),e.jsx(a,{title:"Validación de certificados",href:"/docs/platform/pki/certificate-validation"})]})]})}function u(i={}){const{wrapper:n}=i.components||{};return n?e.jsx(n,{...i,children:e.jsx(o,{...i})}):o(i)}function t(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{c as _markdown,u as default,d as frontmatter,l as structuredData,p as toc};
