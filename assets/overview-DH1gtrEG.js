...
Lamassu runs as a set of services on Kubernetes, backed by PostgreSQL, RabbitMQ and an OIDC provider. Hover a component to trace its connections, or see the [platform architecture](/docs/platform/pki/concepts/architecture) chapter for the low-level, per-service view.
...
`,e.jsx(t.p,{children:"Define enrollment policies with a Device Management Service (DMS) and let devices request or renew their identity through EST."}),`
...
`,e.jsxs(n,{children:[e.jsx(i,{title:"I administer the PKI",description:"Configure engines, authorities, issuance and validation.",href:"/docs/platform/pki/key-management"}),e.jsx(i,{title:"I integrate a device",description:"Configure the DMS and use EST to obtain an identity.",href:"/docs/platform/pki/device-enrollment"}),e.jsx(i,{title:"I operate the platform",description:"Deploy Lamassu and prepare its dependencies.",href:"/docs/deployment/overview"}),e.jsx(i,{title:"I integrate another system",description:"Connect Lamassu with AWS IoT Core and other destinations.",href:"/docs/platform/pki/integrations/aws-iot-core"})]}),`
`,e.jsx(t.h2,{id:"operational-reference",children:"Operational reference"}),`
`,e.jsxs(n,{children:[e.jsx(i,{title:"Certificate profiles",description:"Turn issuance policy into reusable constraints.",href:"/docs/platform/pki/certificate-profiles"}),e.jsx(i,{title:"Hierarchy and rotation",description:"Replace CA certificates or keys without breaking trust.",href:"/docs/platform/pki/ca-hierarchy-and-rotation"}),e.jsx(i,{title:"Access control",description:"Configure principals, policies and the first administrator.",href:"/docs/platform/pki/access-control"}),e.jsx(i,{title:"Troubleshooting",description:"Diagnose the Gateway, services, issuance and enrollment.",href:"/docs/platform/pki/troubleshooting"})]})]})}function u(r={}){const{wrapper:t}=r.components||{};return t?e.jsx(t,{...r,children:e.jsx(s,{...r})}):s(r)}function a(r,t){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}const f=Object.freeze(Object.defineProperty({__proto__:null,_markdown:c,default:u,frontmatter:d,structuredData:l,toc:h},Symbol.toStringTag,{value:"Module"}));export{f as _};
