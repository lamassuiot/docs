...
* **Identidad:** \`auth.oidc.frontend.*\` y \`auth.oidc.apiGateway.jwks\` configuran el login y la validación JWT.
...
`,e.jsxs(s.li,{children:[e.jsx(s.strong,{children:"Identidad:"})," ",e.jsx(s.code,{children:"auth.oidc.frontend.*"})," y ",e.jsx(s.code,{children:"auth.oidc.apiGateway.jwks"})," configuran el login y la validación JWT."]}),`
