...
`]}),`
`,e.jsxs(o,{children:[e.jsx(i,{title:"Arquitectura",description:"Conoce los componentes y dónde termina la responsabilidad de cada uno.",href:"/docs/platform/pki/concepts/architecture"}),e.jsx(i,{title:"Ciclo de vida de una identidad",description:"Sigue un certificado desde el enrolamiento hasta la renovación o revocación.",href:"/docs/platform/pki/concepts/certificate-lifecycle"})]})]})}function u(n={}){const{wrapper:a}=n.components||{};return a?e.jsx(a,{...n,children:e.jsx(t,{...n})}):t(n)}function c(n,a){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const m=Object.freeze(Object.defineProperty({__proto__:null,_markdown:d,default:u,frontmatter:r,structuredData:s,toc:l},Symbol.toStringTag,{value:"Module"}));export{m as _};
