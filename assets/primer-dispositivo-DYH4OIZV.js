...
El registro manual ayuda a entender el modelo, pero una flota debe usar enrolamiento automatizado. Continúa con [Device Management Service](/docs/manual/servicios-core/ra) y la [integración EST](/docs/manual/servicios-core/est).
...
`,e.jsxs(i.p,{children:["El registro manual ayuda a entender el modelo, pero una flota debe usar enrolamiento automatizado. Continúa con ",e.jsx(i.a,{href:"/docs/manual/servicios-core/ra",children:"Device Management Service"})," y la ",e.jsx(i.a,{href:"/docs/manual/servicios-core/est",children:"integración EST"}),"."]})]})}function u(a={}){const{wrapper:i}=a.components||{};return i?e.jsx(i,{...a,children:e.jsx(s,{...a})}):s(a)}function o(a,i){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}export{d as _markdown,u as default,c as frontmatter,l as structuredData,p as toc};
