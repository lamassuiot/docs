...
`,e.jsxs(a.p,{children:["Usa la autoridad para ",e.jsx(a.a,{href:"/docs/manual/inicio/primer-certificado",children:"emitir tu primer certificado"}),", o consulta la ",e.jsx(a.a,{href:"/docs/manual/servicios-core/cas",children:"guía completa de autoridades"})," para crear una CA intermedia, importar una CA o definir perfiles avanzados."]})]})}function m(i={}){const{wrapper:a}=i.components||{};return a?e.jsx(a,{...i,children:e.jsx(c,{...i})}):c(i)}function r(i,a){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{l as _markdown,m as default,d as frontmatter,u as structuredData,p as toc};
