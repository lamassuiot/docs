...
`,e.jsxs(t.p,{children:["Manual registration helps you understand the model, but a fleet should use automated enrollment. Continue with ",e.jsx(t.a,{href:"/docs/platform/pki/device-enrollment",children:"Device Management Service"})," and the ",e.jsx(t.a,{href:"/docs/platform/pki/est-enrollment",children:"EST integration"}),"."]})]})}function l(i={}){const{wrapper:t}=i.components||{};return t?e.jsx(t,{...i,children:e.jsx(a,{...i})}):a(i)}function o(i,t){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const g=Object.freeze(Object.defineProperty({__proto__:null,_markdown:c,default:l,frontmatter:r,structuredData:d,toc:h},Symbol.toStringTag,{value:"Module"}));export{g as _};
