...
`,e.jsxs(i.p,{children:["El registro manual ayuda a entender el modelo, pero una flota debe usar enrolamiento automatizado. Continúa con ",e.jsx(i.a,{href:"/docs/platform/pki/device-enrollment",children:"Device Management Service"})," y la ",e.jsx(i.a,{href:"/docs/platform/pki/est-enrollment",children:"integración EST"}),"."]})]})}function p(a={}){const{wrapper:i}=a.components||{};return i?e.jsx(i,{...a,children:e.jsx(o,{...a})}):o(a)}function s(a,i){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const m=Object.freeze(Object.defineProperty({__proto__:null,_markdown:r,default:p,frontmatter:d,structuredData:c,toc:l},Symbol.toStringTag,{value:"Module"}));export{m as _};
