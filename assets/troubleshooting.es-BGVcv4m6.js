...
`]})]})}function p(a={}){const{wrapper:i}=a.components||{};return i?e.jsx(i,{...a,children:e.jsx(r,{...a})}):r(a)}function s(a,i){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const m=Object.freeze(Object.defineProperty({__proto__:null,_markdown:t,default:p,frontmatter:d,structuredData:c,toc:h},Symbol.toStringTag,{value:"Module"}));export{m as _};
