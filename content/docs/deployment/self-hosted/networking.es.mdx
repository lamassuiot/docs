---
title: Expón el Gateway
description: Elige cómo llegan los clientes a Lamassu, cuándo definir gateway.addresses y cómo diseñar varios Gateways.
---

# Expón el Gateway de Lamassu
...
## Diseño recomendado para un solo nodo
...
### Bare metal con MetalLB o kube-vip
...
## ¿Qué ocurre si necesitas tres Gateways?
