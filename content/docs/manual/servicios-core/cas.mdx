...
Seleccionado la acción ![](/images/image28.png) da acceso a los detalles de la CA y a diferentes opciones de gestión. 
...
La funcionalidad de emisión es accesible también desde el listado de CAs mediante la acción ![](/images/image32.png)  
![](/images/image33.png)
