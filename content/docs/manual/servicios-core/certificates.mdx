...
![](/images/manual-servicios-core-certificates-gestion-de-certificados.png)
...
![](/images/manual-servicios-core-certificates-gestion-de-certificados-a.png)

Por cada certificado se incluye un conjunto de acciones vinculadas al certificado.   
![](/images/manual-servicios-core-certificates-gestion-de-certificados-b.png)  
...
![](/images/manual-servicios-core-certificates-gestion-de-certificados-c.png)  
...
![](/images/manual-servicios-core-certificates-revocacion-de-certificados.png)
...
![](/images/manual-servicios-core-certificates-revocacion-de-certificados-a.png)
