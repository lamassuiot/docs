---
title: "[EST] Referencia para integrador de dispositivos"
...
# EST — Referencia para integrador de dispositivos

Esta página es la referencia operativa del protocolo EST (RFC 7030) para quien integra dispositivos con Lamassu IoT. Describe los endpoints disponibles, los formatos de mensaje, el modelo de autenticación y los casos de error que el firmware o el agente de aprovisionamiento puede encontrar. La configuración del DMS que habilita estos endpoints — modos de autenticación, CA de enrolamiento, ventanas de renovación — está documentada en la [página de configuración EST del DMS](/docs/manual/servicios-core/est-admin), dirigida al administrador PKI.
...
<Cards>
  ...
  <Card title="EST — Configuración del DMS" href="/docs/manual/servicios-core/est-admin" />
