...
description: Diseña quién puede acceder a Lamassu mediante principales, políticas, permisos sobre recursos y autorización de rutas HTTP.
---
...
### Servicios HTTP integrados o externos
...
Cuando permite el acceso, `authz` devuelve el principal seleccionado en la cabecera de respuesta `X-Principal-ID`. El Gateway puede propagar esa cabecera al servicio para conservar el contexto de identidad.
...
### Servicios desarrollados por Lamassu
...
### Cómo se relacionan ambos caminos
...
## Cuando coinciden varios principales
...
## Cómo expresan acceso las políticas

### Acceso global y acceso directo
...
### Acceso heredado por relaciones
...
<Steps>
  <Step>
    ### Prepara el proveedor de identidad
  ...
  <Step>
    ### Configura las dos validaciones JWT
  ...
  <Step>
    ### Prueba una identidad sin privilegios
  ...
  <Step>
    ### Reduce el uso del administrador de bootstrap
...
## Diseña roles de mínimo privilegio
...
## Cambios y revocación de acceso
...
### Todo falla cuando authz no está disponible
