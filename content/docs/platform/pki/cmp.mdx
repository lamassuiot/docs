---
title: Device enrollment with CMP
description: CMP protocol guide for Lamassu IoT, with the complete reference of DMS general and per-operation settings, and the operation reference for device integrators.
sidebar:
  group: RA
  label: CMP
---
...
#### Confirmation and issuance flow
...
#### Protection certificate and proof of possession
...
### Server-side key generation (KGA)
