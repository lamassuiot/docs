...
The CA service issues certificates and maintains the relationship with its authority. The DMS applies the enrollment rules and exposes the flows of the configured protocol — EST or CMP — so a device can request or renew an identity.
