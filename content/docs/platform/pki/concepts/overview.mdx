---
title: How Lamassu works
description: The mental model of trust, keys, certificates and devices.
---
...
3. The device generates a key and requests a certificate through EST or CMP, or an operator assigns it an identity.
