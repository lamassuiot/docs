...
Manual registration helps you understand the model, but a fleet should use automated enrollment. Continue with [Device Management Service](/docs/platform/pki/device-enrollment) and the [EST integration](/docs/platform/pki/est-enrollment) or [CMP](/docs/platform/pki/cmp).
