...
Bare in mind that if two golang engines are enabled simultaneously there will be unexpected behavior if they share the same `storage_directory`. Make sure to specify different paths for each engine
