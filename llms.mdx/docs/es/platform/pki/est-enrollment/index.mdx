# Enrolamiento de dispositivos con EST (/docs/es/platform/pki/est-enrollment)
...
El contrato exacto que debe implementar el servicio webhook (esquema de petición y respuesta, ejemplos) está publicado como especificación OpenAPI: [referencia del webhook de autorización](/docs/api-reference/enroll-reenroll-webhook).
