...
The exact contract the webhook service must implement (request and response schema, examples) is published as an OpenAPI specification: [authorization webhook reference](/docs/api-reference/enroll-reenroll-webhook).
