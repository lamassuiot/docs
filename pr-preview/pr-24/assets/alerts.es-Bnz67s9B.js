...
`]}),`
`,e.jsx(n.p,{children:"Utiliza el catálogo que muestra la consola como fuente para los tipos disponibles en la versión que tienes desplegada."})]})}function u(i={}){const{wrapper:n}=i.components||{};return n?e.jsx(n,{...i,children:e.jsx(o,{...i})}):o(i)}function t(i,n){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const m=Object.freeze(Object.defineProperty({__proto__:null,_markdown:c,default:u,frontmatter:r,structuredData:l,toc:d},Symbol.toStringTag,{value:"Module"}));export{m as _};
