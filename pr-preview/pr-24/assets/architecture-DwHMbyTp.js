...
The CA service issues certificates and maintains the relationship with its authority. The DMS applies the enrollment rules and exposes the <del className="lm-diff-del">EST flows</del><ins className="lm-diff-ins">flows of the configured protocol — EST or CMP —</ins> so a device can request or renew an identity.
...
`,e.jsxs(t.p,{children:["The CA service issues certificates and maintains the relationship with its authority. The DMS applies the enrollment rules and exposes the ",e.jsx(t.del,{className:"lm-diff-del",children:"EST flows"}),e.jsx(t.ins,{className:"lm-diff-ins",children:"flows of the configured protocol — EST or CMP —"})," so a device can request or renew an identity."]}),`
...
`,e.jsxs(t.p,{children:["In a self-managed deployment, Lamassu uses PostgreSQL for persistence, RabbitMQ for messaging and an OIDC provider for authentication. See the ",e.jsx(t.a,{href:"/docs/deployment/self-hosted/overview#architecture",children:"deployment architecture"})," for how the services are published on Kubernetes."]})]})}function d(n={}){const{wrapper:t}=n.components||{};return t?e.jsx(t,{...n,children:e.jsx(a,{...n})}):a(n)}const h=Object.freeze(Object.defineProperty({__proto__:null,_markdown:o,default:d,frontmatter:s,lmDiff:i,structuredData:r,toc:c},Symbol.toStringTag,{value:"Module"}));export{h as _};
