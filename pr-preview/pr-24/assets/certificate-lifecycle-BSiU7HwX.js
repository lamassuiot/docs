...
`]}),`
`,e.jsxs(a.p,{children:["El historial del dispositivo relaciona sus identidades anteriores y actuales. Para cambios administrativos y errores de mutación, consulta ",e.jsx(a.a,{href:"/docs/platform/pki/audit-logs",children:"Registros de auditoría"}),"."]})]})}function p(i={}){const{wrapper:a}=i.components||{};return a?e.jsx(a,{...i,children:e.jsx(c,{...i})}):c(i)}function r(i,a){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{d as _markdown,p as default,l as frontmatter,u as structuredData,v as toc};
