...
`,e.jsxs(o,{children:[e.jsx(t,{title:"Validar con OCSP",description:"Consulta el estado de un certificado en tiempo real.",href:"/docs/platform/pki/ocsp"}),e.jsx(t,{title:"Distribuir una CRL",description:"Publica el estado para validación offline.",href:"/docs/platform/pki/crl"})]})]})}function m(i={}){const{wrapper:a}=i.components||{};return a?e.jsx(a,{...i,children:e.jsx(s,{...i})}):s(i)}function n(i,a){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}const h=Object.freeze(Object.defineProperty({__proto__:null,_markdown:l,default:m,frontmatter:u,structuredData:f,toc:p},Symbol.toStringTag,{value:"Module"}));export{h as _};
