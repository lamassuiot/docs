...
Actualmente, Lamassu soporta cinco tipos de motor. Elige según el nivel de aislamiento que necesites y quién debe poder acceder al material privado.

File System [#file-system]

Genera las claves con las librerías criptográficas de Go y delega su protección en el sistema de archivos. Funciona tanto on-premise como en cloud, pero no evita la extracción de la clave y no está recomendado para producción.

HashiCorp Vault [#hashicorp-vault]

Protege las claves en reposo y puede ejecutarse on-premise o en cloud. Un administrador con permisos suficientes todavía puede visualizar el material privado, por lo que conviene limitar el acceso administrativo y custodiar las claves de *unseal*.
...
Genera las claves con entropía hardware y no expone la clave privada. Las operaciones se ejecutan dentro del servicio. Aun así, una identidad con permisos suficientes podría utilizar la clave para firmar, por lo que la política IAM sigue siendo crítica.
...
`,e.jsx(a.p,{children:"Actualmente, Lamassu soporta cinco tipos de motor. Elige según el nivel de aislamiento que necesites y quién debe poder acceder al material privado."}),`
`,e.jsx(a.h3,{id:"file-system",children:"File System"}),`
`,e.jsx(a.p,{children:"Genera las claves con las librerías criptográficas de Go y delega su protección en el sistema de archivos. Funciona tanto on-premise como en cloud, pero no evita la extracción de la clave y no está recomendado para producción."}),`
`,e.jsx(a.h3,{id:"hashicorp-vault",children:"HashiCorp Vault"}),`
`,e.jsxs(a.p,{children:["Protege las claves en reposo y puede ejecutarse on-premise o en cloud. Un administrador con permisos suficientes todavía puede visualizar el material privado, por lo que conviene limitar el acceso administrativo y custodiar las claves de ",e.jsx(a.em,{children:"unseal"}),"."]}),`
...
`,e.jsx(a.p,{children:"Genera las claves con entropía hardware y no expone la clave privada. Las operaciones se ejecutan dentro del servicio. Aun así, una identidad con permisos suficientes podría utilizar la clave para firmar, por lo que la política IAM sigue siendo crítica."}),`
...
`,e.jsx(a.p,{children:"Esta opción muestra los pasos necesarios para configurar el entorno local, cargar el módulo PKCS#11 y ejecutar firmas con herramientas como OpenSSL sin extraer la clave privada del entorno custodiado."})]})}function c(n={}){const{wrapper:a}=n.components||{};return a?e.jsx(a,{...n,children:e.jsx(i,{...n})}):i(n)}const d=Object.freeze(Object.defineProperty({__proto__:null,_markdown:r,default:c,frontmatter:s,structuredData:o,toc:t},Symbol.toStringTag,{value:"Module"}));export{d as _};
