...
`,e.jsxs(i.p,{children:["El registro manual ayuda a entender el modelo, pero una flota debe usar enrolamiento automatizado. Continúa con ",e.jsx(i.a,{href:"/docs/platform/pki/device-enrollment",children:"Device Management Service"})," y la ",e.jsx(i.a,{href:"/docs/platform/pki/est-enrollment",children:"integración EST"}),e.jsx(i.ins,{className:"lm-diff-ins",children:" o "}),e.jsx(i.a,{href:"/docs/platform/pki/cmp",children:e.jsx(i.ins,{className:"lm-diff-ins",children:"CMP"})}),"."]})]})}function u(a={}){const{wrapper:i}=a.components||{};return i?e.jsx(i,{...a,children:e.jsx(s,{...a})}):s(a)}function o(a,i){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}const g=Object.freeze(Object.defineProperty({__proto__:null,_markdown:r,default:u,frontmatter:d,lmDiff:c,structuredData:l,toc:p},Symbol.toStringTag,{value:"Module"}));export{g as _};
