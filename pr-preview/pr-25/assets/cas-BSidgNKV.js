...
<div className="lm-diff-ins lm-diff-block">
  El formulario de la consola ofrece los tipos clásicos RSA y EC. A través de la API se pueden crear CAs con cualquiera de los tipos de clave soportados por el motor seleccionado, incluidos Ed25519 y los algoritmos post-cuánticos (ML-DSA, SLH-DSA y Composite ML-DSA). Consulte la sección de algoritmos de la página de [gestión de claves del KMS](/docs/manual/servicios-core/kms) para conocer el catálogo completo y las restricciones por motor.
</div>
...
<div className="lm-diff-ins lm-diff-block">
  La CA superior seleccionada no está limitada a un algoritmo concreto: Lamassu permite combinar jerarquías con algoritmos distintos, por ejemplo una CA intermedia post-cuántica bajo una raíz clásica o al contrario. Tenga en cuenta que la interoperabilidad de la jerarquía resultante dependerá de que los clientes que validen los certificados soporten los algoritmos utilizados en cada nivel.
</div>
...
`]}),`
`,e.jsx(i.div,{className:"lm-diff-ins lm-diff-block",children:e.jsxs(i.p,{children:["El formulario de la consola ofrece los tipos clásicos RSA y EC. A través de la API se pueden crear CAs con cualquiera de los tipos de clave soportados por el motor seleccionado, incluidos Ed25519 y los algoritmos post-cuánticos (ML-DSA, SLH-DSA y Composite ML-DSA). Consulte la sección de algoritmos de la página de ",e.jsx(i.a,{href:"/docs/manual/servicios-core/kms",children:"gestión de claves del KMS"})," para conocer el catálogo completo y las restricciones por motor."]})}),`
...
`]}),`
`]}),`
`,e.jsx(i.div,{className:"lm-diff-ins lm-diff-block",children:e.jsx(i.p,{children:"La CA superior seleccionada no está limitada a un algoritmo concreto: Lamassu permite combinar jerarquías con algoritmos distintos, por ejemplo una CA intermedia post-cuántica bajo una raíz clásica o al contrario. Tenga en cuenta que la interoperabilidad de la jerarquía resultante dependerá de que los clientes que validen los certificados soporten los algoritmos utilizados en cada nivel."})}),`
...
`]})]})}function l(a={}){const{wrapper:i}=a.components||{};return i?e.jsx(i,{...a,children:e.jsx(n,{...a})}):n(a)}export{d as _markdown,l as default,r as frontmatter,o as lmDiff,s as structuredData,t as toc};
