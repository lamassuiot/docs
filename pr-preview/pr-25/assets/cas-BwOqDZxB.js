...
* **Key Type:** RSA / EC (Elliptic Curve)<ins className="lm-diff-ins">, Ed25519 y los tipos post-cuánticos e híbridos (ML-DSA, SLH-DSA y Composite-ML-DSA), según el motor seleccionado</ins>
* **Key Size:**
  * RSA: 1024, 2048, 3072, 4096 bits
  * EC: P-256, P-384, P-521
  * Ed25519: tamaño fijo 256
  * ML-DSA: 44, 65, 87
  * SLH-DSA: conjunto de parámetros del 1 al 12
  * Composite-ML-DSA: variante del 1 al 15, según la familia (RSA 1-8, ECDSA 9-13, Ed25519 14-15)
* **Recomendado:** EC P-384

<div className="lm-diff-ins lm-diff-block">
  La disponibilidad de estos tipos de clave depende del motor criptográfico seleccionado. Si se elige un tipo de clave que el motor no admite, la creación de la CA se rechaza. Consulte la tabla de tipos de clave del servicio KMS para más detalles.
</div>
...
<div className="lm-diff-ins lm-diff-block">
  Cualquier clave registrada en el KMS puede servir de soporte a una CA, incluidas las de tipo post-cuántico o híbrido. Esto permite construir jerarquías de confianza en las que el tipo de clave del emisor no tiene por qué coincidir con el del sujeto: por ejemplo, una CA raíz ML-DSA puede emitir certificados sobre claves RSA o ECDSA, y viceversa.
</div>
...
<div className="lm-diff-ins lm-diff-block">
  La clave privada se importa a través del mecanismo de importación de claves del servicio KMS (formato PKCS#8), por lo que se admiten los mismos tipos de clave: RSA, ECDSA, Ed25519, ML-DSA, SLH-DSA y Composite-ML-DSA, según el soporte del motor seleccionado. El algoritmo y el tamaño se detectan automáticamente a partir del material importado.
</div>
...
<div className="lm-diff-ins lm-diff-block">
  El CSR externo puede estar firmado con cualquier tipo de clave admitido por la plataforma, incluidos los tipos post-cuánticos e híbridos. No es necesario que el tipo de clave del CSR coincida con el de la CA emisora: por ejemplo, una CA RSA o ECDSA puede emitir certificados sobre claves ML-DSA o Composite-ML-DSA, y viceversa.
</div>
...
`,e.jsxs(i.ul,{children:[`
`,e.jsxs(i.li,{children:[e.jsx(i.strong,{children:"Key Type:"})," RSA / EC (Elliptic Curve)",e.jsx(i.ins,{className:"lm-diff-ins",children:", Ed25519 y los tipos post-cuánticos e híbridos (ML-DSA, SLH-DSA y Composite-ML-DSA), según el motor seleccionado"})]}),`
...
`,e.jsx(i.li,{className:"lm-diff-ins lm-diff-block",children:"Ed25519: tamaño fijo 256"}),`
`,e.jsx(i.li,{className:"lm-diff-ins lm-diff-block",children:"ML-DSA: 44, 65, 87"}),`
`,e.jsx(i.li,{className:"lm-diff-ins lm-diff-block",children:"SLH-DSA: conjunto de parámetros del 1 al 12"}),`
`,e.jsx(i.li,{className:"lm-diff-ins lm-diff-block",children:"Composite-ML-DSA: variante del 1 al 15, según la familia (RSA 1-8, ECDSA 9-13, Ed25519 14-15)"}),`
`]}),`
`]}),`
`,e.jsxs(i.li,{children:[e.jsx(i.strong,{children:"Recomendado:"})," EC P-384"]}),`
`]}),`
`,e.jsx(i.div,{className:"lm-diff-ins lm-diff-block",children:e.jsx(i.p,{children:"La disponibilidad de estos tipos de clave depende del motor criptográfico seleccionado. Si se elige un tipo de clave que el motor no admite, la creación de la CA se rechaza. Consulte la tabla de tipos de clave del servicio KMS para más detalles."})}),`
...
`,e.jsx(i.div,{className:"lm-diff-ins lm-diff-block",children:e.jsx(i.p,{children:"Cualquier clave registrada en el KMS puede servir de soporte a una CA, incluidas las de tipo post-cuántico o híbrido. Esto permite construir jerarquías de confianza en las que el tipo de clave del emisor no tiene por qué coincidir con el del sujeto: por ejemplo, una CA raíz ML-DSA puede emitir certificados sobre claves RSA o ECDSA, y viceversa."})}),`
...
`,e.jsx(i.div,{className:"lm-diff-ins lm-diff-block",children:e.jsx(i.p,{children:"La clave privada se importa a través del mecanismo de importación de claves del servicio KMS (formato PKCS#8), por lo que se admiten los mismos tipos de clave: RSA, ECDSA, Ed25519, ML-DSA, SLH-DSA y Composite-ML-DSA, según el soporte del motor seleccionado. El algoritmo y el tamaño se detectan automáticamente a partir del material importado."})}),`
...
`,e.jsx(i.div,{className:"lm-diff-ins lm-diff-block",children:e.jsx(i.p,{children:"El CSR externo puede estar firmado con cualquier tipo de clave admitido por la plataforma, incluidos los tipos post-cuánticos e híbridos. No es necesario que el tipo de clave del CSR coincida con el de la CA emisora: por ejemplo, una CA RSA o ECDSA puede emitir certificados sobre claves ML-DSA o Composite-ML-DSA, y viceversa."})}),`
...
`]})]})}function l(a={}){const{wrapper:i}=a.components||{};return i?e.jsx(i,{...a,children:e.jsx(n,{...a})}):n(a)}export{d as _markdown,l as default,o as frontmatter,r as lmDiff,s as structuredData,t as toc};
