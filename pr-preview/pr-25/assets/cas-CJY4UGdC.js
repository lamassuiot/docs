...
* **Key Type:** RSA / EC (Elliptic Curve), ML-DSA, SLH-DSA, Ed25519 y firmas compuestas (Composite ML-DSA)
* **Key Size:**
  * RSA: 1024, 2048, 3072, 4096 bits
  * EC: P-256, P-384, P-521
  * ML-DSA: 44, 65 o 87
  * SLH-DSA: parámetro 1 a 12
  * Ed25519: 256
  * Composite ML-DSA: variante 1 a 15
* **Recomendado:** EC P-384

Los tipos de clave disponibles dependen del motor criptográfico seleccionado: los tipos post-cuánticos, Ed25519 y las firmas compuestas solo los soportan el motor software y el motor File System. Consulte [Criptografía post-cuántica (LamassuQ)](/docs/manual/servicios-core/lamassuq) para el detalle de variantes y motores.
...
Para las CAs con claves post-cuánticas, Ed25519 o compuestas, la clave privada debe proporcionarse en formato PKCS#8 y el motor seleccionado debe soportar el tipo de clave; consulte [Criptografía post-cuántica (LamassuQ)](/docs/manual/servicios-core/lamassuq#importación-de-claves-post-cuánticas).
...
El tipo de clave del certificado emitido no tiene por qué coincidir con el de la CA emisora, ya que la firma del certificado la realiza siempre la clave de la CA emisora. Una CA con clave post-cuántica, Ed25519 o compuesta puede emitir certificados para claves tradicionales, y una CA tradicional puede emitir certificados para CSRs con claves post-cuánticas, Ed25519 o compuestas. Consulte [Cadenas de certificados mixtas](/docs/manual/servicios-core/lamassuq#cadenas-de-certificados-mixtas).
...
Se debe especificar el tipo de clave a ser generada para la solicitud del certificado. La generación en el navegador solo está disponible para los algoritmos tradicionales (ECDSA y RSA); para claves post-cuánticas, Ed25519 o compuestas, utilice la opción de emisión a partir de un CSR generado de manera externa.
...
Se debe especificar el tipo de clave a ser generada para la solicitud del certificado. La generación en el navegador solo está disponible para los algoritmos tradicionales (ECDSA y RSA); para claves post-cuánticas, Ed25519 o compuestas, utilice la opción de emisión a partir de un CSR generado de manera externa.`},{heading:"emisión-de-certificados",content:"**Algorithm (Algoritmo)**"},{heading:"emisión-de-certificados",content:"**ECDSA:** Algoritmo de curva elíptica, se debe especificar la curva a utilizar"},{heading:"emisión-de-certificados",content:"**RSA:** Algoritmo RSA tradicional, se debe indicar el tamaño de clave"},{heading:"emisión-de-certificados",content:"**Certificate Configuration (Configuración del certificado)**"},{heading:"emisión-de-certificados",content:"**Validity Duration (Duración de validez)**"},{heading:"emisión-de-certificados",content:"Indica la fecha de expiración del certificado a emitir como una expresión de duración"},{heading:"emisión-de-certificados",content:"**Campo:** Configurable según necesidades"},{heading:"emisión-de-certificados",content:"**Valor por defecto:** 1 año (1y)"},{heading:"emisión-de-certificados",content:"**Unidades válidas:** y (años), w (semanas), d (días), h (horas), m (minutos), s (segundos)"},{heading:"emisión-de-certificados",content:"**Consideración:** No puede exceder la validez de la CA emisora"},{heading:"emisión-de-certificados",content:`**Key Usage (Uso de claves)**
...
`,e.jsxs(i.ul,{children:[`
`,e.jsxs(i.li,{children:[e.jsx(i.strong,{children:"Key Type:"})," RSA / EC (Elliptic Curve), ML-DSA, SLH-DSA, Ed25519 y firmas compuestas (Composite ML-DSA)"]}),`
...
`,e.jsx(i.li,{children:"ML-DSA: 44, 65 o 87"}),`
`,e.jsx(i.li,{children:"SLH-DSA: parámetro 1 a 12"}),`
`,e.jsx(i.li,{children:"Ed25519: 256"}),`
`,e.jsx(i.li,{children:"Composite ML-DSA: variante 1 a 15"}),`
`]}),`
`]}),`
`,e.jsxs(i.li,{children:[e.jsx(i.strong,{children:"Recomendado:"})," EC P-384"]}),`
`]}),`
`,e.jsxs(i.p,{children:["Los tipos de clave disponibles dependen del motor criptográfico seleccionado: los tipos post-cuánticos, Ed25519 y las firmas compuestas solo los soportan el motor software y el motor File System. Consulte ",e.jsx(i.a,{href:"/docs/manual/servicios-core/lamassuq",children:"Criptografía post-cuántica (LamassuQ)"})," para el detalle de variantes y motores."]}),`
...
`]}),`
`,e.jsxs(i.p,{children:["Para las CAs con claves post-cuánticas, Ed25519 o compuestas, la clave privada debe proporcionarse en formato PKCS#8 y el motor seleccionado debe soportar el tipo de clave; consulte ",e.jsx(i.a,{href:"/docs/manual/servicios-core/lamassuq#importaci%C3%B3n-de-claves-post-cu%C3%A1nticas",children:"Criptografía post-cuántica (LamassuQ)"}),"."]}),`
...
`,e.jsxs(i.p,{children:["El tipo de clave del certificado emitido no tiene por qué coincidir con el de la CA emisora, ya que la firma del certificado la realiza siempre la clave de la CA emisora. Una CA con clave post-cuántica, Ed25519 o compuesta puede emitir certificados para claves tradicionales, y una CA tradicional puede emitir certificados para CSRs con claves post-cuánticas, Ed25519 o compuestas. Consulte ",e.jsx(i.a,{href:"/docs/manual/servicios-core/lamassuq#cadenas-de-certificados-mixtas",children:"Cadenas de certificados mixtas"}),"."]}),`
