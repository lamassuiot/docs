...
* **Key Type:** RSA<del className="lm-diff-del"> /</del><ins className="lm-diff-ins">,</ins> EC (Elliptic Curve)<ins className="lm-diff-ins">, Ed25519 y los algoritmos post-cuánticos ML-DSA, SLH-DSA y Composite-ML-DSA</ins>
* **Key Size:**
  * RSA: 1024, 2048, 3072, 4096 bits
  * EC: P-256, P-384, P-521
  * Ed25519: 256 bits
  * ML-DSA: niveles 44, 65 y 87
  * SLH-DSA: juegos de parámetros del 1 al 12
  * Composite-ML-DSA: variantes compuestas de ML-DSA con RSA, ECDSA o Ed25519
* **Recomendado:** EC P-384

<div className="lm-diff-ins lm-diff-block">
  La disponibilidad de los algoritmos post-cuánticos depende del motor criptográfico seleccionado. Consulte la sección [Tipos de clave y algoritmos soportados](/docs/manual/servicios-core/kms#tipos-de-clave-y-algoritmos-soportados) de la página del KMS para conocer la matriz soportada por cada motor.
</div>
...
<div className="lm-diff-ins lm-diff-block">
  La clave privada importada puede corresponder a los algoritmos clásicos (RSA, ECDSA, Ed25519) o a los algoritmos post-cuánticos soportados por Lamassu (ML-DSA, SLH-DSA y Composite-ML-DSA), siempre que el motor seleccionado declare soporte para el algoritmo de la clave.
</div>
...
`,e.jsxs(i.ul,{children:[`
`,e.jsxs(i.li,{children:[e.jsx(i.strong,{children:"Key Type:"})," RSA",e.jsx(i.del,{className:"lm-diff-del",children:" /"}),e.jsx(i.ins,{className:"lm-diff-ins",children:","})," EC (Elliptic Curve)",e.jsx(i.ins,{className:"lm-diff-ins",children:", Ed25519 y los algoritmos post-cuánticos ML-DSA, SLH-DSA y Composite-ML-DSA"})]}),`
...
`,e.jsx(i.li,{className:"lm-diff-ins lm-diff-block",children:"Ed25519: 256 bits"}),`
`,e.jsx(i.li,{className:"lm-diff-ins lm-diff-block",children:"ML-DSA: niveles 44, 65 y 87"}),`
`,e.jsx(i.li,{className:"lm-diff-ins lm-diff-block",children:"SLH-DSA: juegos de parámetros del 1 al 12"}),`
`,e.jsx(i.li,{className:"lm-diff-ins lm-diff-block",children:"Composite-ML-DSA: variantes compuestas de ML-DSA con RSA, ECDSA o Ed25519"}),`
`]}),`
`]}),`
`,e.jsxs(i.li,{children:[e.jsx(i.strong,{children:"Recomendado:"})," EC P-384"]}),`
`]}),`
`,e.jsx(i.div,{className:"lm-diff-ins lm-diff-block",children:e.jsxs(i.p,{children:["La disponibilidad de los algoritmos post-cuánticos depende del motor criptográfico seleccionado. Consulte la sección ",e.jsx(i.a,{href:"/docs/manual/servicios-core/kms#tipos-de-clave-y-algoritmos-soportados",children:"Tipos de clave y algoritmos soportados"})," de la página del KMS para conocer la matriz soportada por cada motor."]})}),`
...
`]}),`
`,e.jsx(i.div,{className:"lm-diff-ins lm-diff-block",children:e.jsx(i.p,{children:"La clave privada importada puede corresponder a los algoritmos clásicos (RSA, ECDSA, Ed25519) o a los algoritmos post-cuánticos soportados por Lamassu (ML-DSA, SLH-DSA y Composite-ML-DSA), siempre que el motor seleccionado declare soporte para el algoritmo de la clave."})}),`
