...
Lamassu IoT trabaja con claves asimétricas: además de RSA y curvas elípticas, soporta algoritmos post-cuánticos (ML-DSA y SLH-DSA), Ed25519 y firmas compuestas que combinan ML-DSA con un algoritmo tradicional. Estas claves se usan para emitir certificados X.509, firmar solicitudes y realizar operaciones de autenticación y validación dentro del sistema.

Consulte [Criptografía post-cuántica (LamassuQ)](/docs/manual/servicios-core/lamassuq) para conocer los nuevos tipos de clave, sus parámetros y las limitaciones de motor que aplican.
...
<Callout type="warn" title="Soporte de tipos de clave según motor">
  Los algoritmos post-cuánticos, Ed25519 y las firmas compuestas solo pueden generarse e importarse en el motor software (Golang) y en el motor File System. El resto de motores externos rechazan estos tipos de clave con el error \`unsupported key type\`. Consulte [Motores criptográficos compatibles](/docs/manual/servicios-core/lamassuq#motores-criptográficos-compatibles).
</Callout>
...
* **Type**: algoritmo y tamaño de clave, por ejemplo RSA 2048, EC P-256, ML-DSA 65 o Composite-ML-DSA-ECDSA 10.
...
* **Key Type** y **Key Size**: algoritmo y tamaño o curva. Además de RSA y curvas elípticas, se pueden seleccionar ML-DSA (44, 65 o 87), SLH-DSA (parámetros 1 a 12), Ed25519 y las variantes compuestas; consulte [Criptografía post-cuántica (LamassuQ)](/docs/manual/servicios-core/lamassuq).
...
* **Private Key (PEM)**: clave privada en formato PEM. Para los tipos post-cuánticos, Ed25519 y compuestos, el formato requerido es PKCS#8; consulte [Importación de claves post-cuánticas](/docs/manual/servicios-core/lamassuq#importación-de-claves-post-cuánticas).
...
<Callout type="info" title="Algoritmos de firma PURE">
  Los algoritmos post-cuánticos, Ed25519 y las firmas compuestas operan en modo PURE: firman el mensaje tal cual, sin pre-hash. En las pestañas **Sign** y **Verify**, seleccione el tipo de mensaje \`Raw\`. Consulte [Firmas en modo PURE](/docs/manual/servicios-core/lamassuq#firmas-en-modo-pure) para los identificadores de algoritmo disponibles.
</Callout>
...
`,e.jsx(a.p,{children:"Lamassu IoT trabaja con claves asimétricas: además de RSA y curvas elípticas, soporta algoritmos post-cuánticos (ML-DSA y SLH-DSA), Ed25519 y firmas compuestas que combinan ML-DSA con un algoritmo tradicional. Estas claves se usan para emitir certificados X.509, firmar solicitudes y realizar operaciones de autenticación y validación dentro del sistema."}),`
`,e.jsxs(a.p,{children:["Consulte ",e.jsx(a.a,{href:"/docs/manual/servicios-core/lamassuq",children:"Criptografía post-cuántica (LamassuQ)"})," para conocer los nuevos tipos de clave, sus parámetros y las limitaciones de motor que aplican."]}),`
...
`,e.jsx(i,{type:"warn",title:"Soporte de tipos de clave según motor",children:e.jsxs(a.p,{children:["Los algoritmos post-cuánticos, Ed25519 y las firmas compuestas solo pueden generarse e importarse en el motor software (Golang) y en el motor File System. El resto de motores externos rechazan estos tipos de clave con el error ",e.jsx(a.code,{children:"unsupported key type"}),". Consulte ",e.jsx(a.a,{href:"/docs/manual/servicios-core/lamassuq#motores-criptogr%C3%A1ficos-compatibles",children:"Motores criptográficos compatibles"}),"."]})}),`
...
`,e.jsxs(a.li,{children:[e.jsx(a.strong,{children:"Type"}),": algoritmo y tamaño de clave, por ejemplo RSA 2048, EC P-256, ML-DSA 65 o Composite-ML-DSA-ECDSA 10."]}),`
...
`,e.jsxs(a.li,{children:[e.jsx(a.strong,{children:"Key Type"})," y ",e.jsx(a.strong,{children:"Key Size"}),": algoritmo y tamaño o curva. Además de RSA y curvas elípticas, se pueden seleccionar ML-DSA (44, 65 o 87), SLH-DSA (parámetros 1 a 12), Ed25519 y las variantes compuestas; consulte ",e.jsx(a.a,{href:"/docs/manual/servicios-core/lamassuq",children:"Criptografía post-cuántica (LamassuQ)"}),"."]}),`
...
`,e.jsxs(a.li,{children:[e.jsx(a.strong,{children:"Private Key (PEM)"}),": clave privada en formato PEM. Para los tipos post-cuánticos, Ed25519 y compuestos, el formato requerido es PKCS#8; consulte ",e.jsx(a.a,{href:"/docs/manual/servicios-core/lamassuq#importaci%C3%B3n-de-claves-post-cu%C3%A1nticas",children:"Importación de claves post-cuánticas"}),"."]}),`
`]}),`
...
`]}),`
`,e.jsx(i,{type:"info",title:"Algoritmos de firma PURE",children:e.jsxs(a.p,{children:["Los algoritmos post-cuánticos, Ed25519 y las firmas compuestas operan en modo PURE: firman el mensaje tal cual, sin pre-hash. En las pestañas ",e.jsx(a.strong,{children:"Sign"})," y ",e.jsx(a.strong,{children:"Verify"}),", seleccione el tipo de mensaje ",e.jsx(a.code,{children:"Raw"}),". Consulte ",e.jsx(a.a,{href:"/docs/manual/servicios-core/lamassuq#firmas-en-modo-pure",children:"Firmas en modo PURE"})," para los identificadores de algoritmo disponibles."]})}),`
...
`,e.jsx(a.p,{children:"Esta opción muestra los pasos necesarios para configurar el entorno local, cargar el módulo PKCS#11 y ejecutar firmas con herramientas como OpenSSL sin extraer la clave privada del entorno custodiado."})]})}function p(n={}){const{wrapper:a}=n.components||{};return a?e.jsx(a,{...n,children:e.jsx(r,{...n})}):r(n)}function s(n,a){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}export{t as _markdown,p as default,c as frontmatter,l as structuredData,d as toc};
