...
`,e.jsx(a.div,{className:"lm-diff-ins lm-diff-block",children:e.jsx(a.h2,{id:"algoritmos-y-tamaños-de-clave-soportados",children:"Algoritmos y tamaños de clave soportados"})}),`
`,e.jsx(a.div,{className:"lm-diff-ins lm-diff-block",children:e.jsx(a.p,{children:"El catálogo de claves que puede gestionar el KMS combina algoritmos clásicos y de firma post-cuántica:"})}),`
`,e.jsx(a.div,{className:"lm-diff-ins lm-diff-block",children:e.jsxs(a.table,{children:[e.jsx(a.thead,{children:e.jsxs(a.tr,{children:[e.jsx(a.th,{style:{textAlign:"left"},children:"Familia"}),e.jsxs(a.th,{style:{textAlign:"left"},children:["Algoritmo (",e.jsx(a.code,{children:"Algorithm"}),")"]}),e.jsxs(a.th,{style:{textAlign:"left"},children:["Tamaños y parámetros (",e.jsx(a.code,{children:"Size"}),")"]})]})}),e.jsxs(a.tbody,{children:[e.jsxs(a.tr,{children:[e.jsx(a.td,{style:{textAlign:"left"},children:"RSA"}),e.jsx(a.td,{style:{textAlign:"left"},children:"RSA"}),e.jsx(a.td,{style:{textAlign:"left"},children:"1024, 2048, 3072, 4096, 7680 y 15360 bits"})]}),e.jsxs(a.tr,{children:[e.jsx(a.td,{style:{textAlign:"left"},children:"Curvas elípticas"}),e.jsx(a.td,{style:{textAlign:"left"},children:"ECDSA"}),e.jsx(a.td,{style:{textAlign:"left"},children:"P-224, P-256, P-384 y P-521"})]}),e.jsxs(a.tr,{children:[e.jsx(a.td,{style:{textAlign:"left"},children:"Ed25519"}),e.jsx(a.td,{style:{textAlign:"left"},children:"Ed25519"}),e.jsx(a.td,{style:{textAlign:"left"},children:"Tamaño fijo de 256 bits"})]}),e.jsxs(a.tr,{children:[e.jsx(a.td,{style:{textAlign:"left"},children:"ML-DSA"}),e.jsx(a.td,{style:{textAlign:"left"},children:"ML-DSA"}),e.jsx(a.td,{style:{textAlign:"left"},children:"Variantes 44, 65 y 87"})]}),e.jsxs(a.tr,{children:[e.jsx(a.td,{style:{textAlign:"left"},children:"SLH-DSA"}),e.jsx(a.td,{style:{textAlign:"left"},children:"SLH-DSA"}),e.jsx(a.td,{style:{textAlign:"left"},children:"Conjuntos de parámetros del 1 al 12"})]}),e.jsxs(a.tr,{children:[e.jsx(a.td,{style:{textAlign:"left"},children:"Composite ML-DSA"}),e.jsx(a.td,{style:{textAlign:"left"},children:"Composite-ML-DSA-RSA"}),e.jsx(a.td,{style:{textAlign:"left"},children:"Variantes 1 a 8"})]}),e.jsxs(a.tr,{children:[e.jsx(a.td,{style:{textAlign:"left"},children:"Composite ML-DSA"}),e.jsx(a.td,{style:{textAlign:"left"},children:"Composite-ML-DSA-ECDSA"}),e.jsx(a.td,{style:{textAlign:"left"},children:"Variantes 9 a 13"})]}),e.jsxs(a.tr,{children:[e.jsx(a.td,{style:{textAlign:"left"},children:"Composite ML-DSA"}),e.jsx(a.td,{style:{textAlign:"left"},children:"Composite-ML-DSA-Ed25519"}),e.jsx(a.td,{style:{textAlign:"left"},children:"Variantes 14 a 15"})]})]})]})}),`
`,e.jsx(a.div,{className:"lm-diff-ins lm-diff-block",children:e.jsx(a.p,{children:"Consideraciones sobre estos algoritmos:"})}),`
`,e.jsx(a.div,{className:"lm-diff-ins lm-diff-block",children:e.jsxs(a.ul,{children:[`
`,e.jsxs(a.li,{children:[e.jsx(a.strong,{children:"ML-DSA"})," y ",e.jsx(a.strong,{children:"SLH-DSA"})," son los esquemas de firma digital post-cuántica estandarizados por NIST en las publicaciones FIPS 204 y FIPS 205. En ML-DSA el tamaño selecciona el nivel de seguridad (ML-DSA-44, ML-DSA-65 o ML-DSA-87); en SLH-DSA, el valor del 1 al 12 identifica el conjunto de parámetros del esquema."]}),`
`,e.jsxs(a.li,{children:[e.jsx(a.strong,{children:"Composite ML-DSA"})," combina ML-DSA con un algoritmo clásico (RSA, ECDSA o Ed25519) en una única clave, lo que facilita la migración post-cuántica manteniendo compatibilidad con las infraestructuras clásicas. El número de variante identifica la combinación exacta de ML-DSA, algoritmo clásico y función hash; por ejemplo, la variante 1 equivale a ML-DSA-44 con RSA 2048 (PSS-SHA256) y la variante 14 a ML-DSA-44 con Ed25519."]}),`
`,e.jsxs(a.li,{children:[e.jsx(a.strong,{children:"Ed25519"})," es un esquema de firma de curva elíptica con tamaño fijo; no es necesario indicar un tamaño al crear la clave."]}),`
`]})}),`
`,e.jsx(a.div,{className:"lm-diff-ins lm-diff-block",children:e.jsx(a.p,{children:"La disponibilidad de estos tipos depende del motor criptográfico seleccionado. Todos los motores trabajan con el catálogo clásico basado en RSA y ECDSA, si bien los tamaños concretos pueden variar según el proveedor o el HSM. Los nuevos tipos (Ed25519, ML-DSA, SLH-DSA y Composite ML-DSA) están soportados de extremo a extremo, tanto en generación como en importación, por el motor File System. Si se solicita a un motor un tipo o tamaño que no soporta, la operación se rechaza con un error."})}),`
...
`,e.jsxs(a.p,{children:["Cada motor define qué algoritmos ",e.jsx(a.del,{className:"lm-diff-del",children:"soporta, como RSA o ECC/ECDSA, y qué tamaños de clave puede generar"}),e.jsx(a.ins,{className:"lm-diff-ins",children:"y tamaños de clave soporta (ver la sección "}),e.jsx(a.em,{children:e.jsx(a.ins,{className:"lm-diff-ins",children:"Algoritmos y tamaños de clave soportados"})}),e.jsx(a.ins,{className:"lm-diff-ins",children:") y rechaza las operaciones que se le solicitan fuera de ese catálogo"}),"."]}),`
...
`]}),`
`,e.jsx(a.div,{className:"lm-diff-ins lm-diff-block",children:e.jsxs(a.p,{children:["Los tipos y tamaños disponibles dependen del motor seleccionado (ver la sección ",e.jsx(a.em,{children:"Algoritmos y tamaños de clave soportados"}),"). Para las claves Ed25519 no es necesario indicar tamaño y para las familias post-cuánticas el tamaño corresponde a la variante del algoritmo."]})}),`
...
`]}),`
`,e.jsx(a.div,{className:"lm-diff-ins lm-diff-block",children:e.jsx(a.p,{children:"La clave puede corresponder a cualquiera de los algoritmos soportados por el motor seleccionado, incluidos Ed25519 y los algoritmos post-cuánticos (ML-DSA, SLH-DSA y Composite ML-DSA)."})}),`
...
`]}),`
`,e.jsx(a.div,{className:"lm-diff-ins lm-diff-block",children:e.jsxs(a.p,{children:["Para las claves Ed25519 y post-cuánticas (ML-DSA, SLH-DSA y Composite ML-DSA), los algoritmos de firma disponibles operan en modo ",e.jsx(a.em,{children:"pure"}),": firman el mensaje original directamente, sin necesidad de precalcular un ",e.jsx(a.em,{children:"digest"}),". Por ello, seleccione ",e.jsx(a.code,{children:"Raw"})," como ",e.jsx(a.strong,{children:"Message Type"}),", ya que el algoritmo opera directamente sobre el contenido recibido. Los algoritmos correspondientes llevan el sufijo ",e.jsx(a.code,{children:"_PURE"}),", como ",e.jsx(a.code,{children:"MLDSA_65_PURE"}),", ",e.jsx(a.code,{children:"SLHDSA_PURE"}),", ",e.jsx(a.code,{children:"COMPOSITE_MLDSA_RSA_PURE"})," o ",e.jsx(a.code,{children:"Ed25519_PURE"}),"."]})}),`
