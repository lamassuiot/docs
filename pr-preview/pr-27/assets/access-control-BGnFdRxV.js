...
Cuando permite el acceso, \`authz\` devuelve el principal seleccionado en <del className="lm-diff-del">\`x-current-user\`</del><ins className="lm-diff-ins">la cabecera de respuesta \`X-Principal-ID\`</ins>. El Gateway puede propagar esa cabecera al servicio para conservar el contexto de identidad.
...
`]}),`
`,e.jsxs(a.p,{children:["Cuando permite el acceso, ",e.jsx(a.code,{children:"authz"})," devuelve el principal seleccionado en ",e.jsx(a.del,{className:"lm-diff-del",children:e.jsx(a.code,{children:"x-current-user"})}),e.jsxs(a.ins,{className:"lm-diff-ins",children:["la cabecera de respuesta ",e.jsx(a.code,{children:"X-Principal-ID"})]}),". El Gateway puede propagar esa cabecera al servicio para conservar el contexto de identidad."]}),`
...
`,e.jsxs(a.p,{children:["Continúa con ",e.jsx(a.a,{href:"/docs/platform/pki/audit-logs",children:"Registros de auditoría"})," para investigar cambios de configuración o con ",e.jsx(a.a,{href:"/docs/platform/pki/troubleshooting",children:"Resolución de problemas"})," para diagnosticar el despliegue."]})]})}function m(i={}){const{wrapper:a}=i.components||{};return a?e.jsx(a,{...i,children:e.jsx(c,{...i})}):c(i)}function o(i,a){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{d as _markdown,m as default,t as frontmatter,p as lmDiff,u as structuredData,h as toc};
