...
`]}),`
`,e.jsxs(a.p,{children:["Consulta el ",e.jsx(a.a,{href:"/docs/platform/pki/concepts/trust-model",children:"Modelo de confianza"})," para entender los conjuntos de CAs del DMS y ",e.jsx(a.a,{href:"/docs/platform/pki/concepts/certificate-lifecycle",children:"Ciclo de vida de un certificado"})," para los estados y efectos de revocación."]})]})}function p(n={}){const{wrapper:a}=n.components||{};return a?e.jsx(a,{...n,children:e.jsx(c,{...n})}):c(n)}function o(n,a){throw new Error("Expected component `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}export{d as _markdown,p as default,l as frontmatter,u as structuredData,m as toc};
