...
`,e.jsx(i.p,{children:"Antes de eliminar un perfil, comprueba que ninguna CA o DMS dependa de él. Si deseas sustituirlo, crea la versión nueva, actualiza las referencias y realiza una emisión de prueba antes de retirar el anterior."})]})}function m(a={}){const{wrapper:i}=a.components||{};return i?e.jsx(i,{...a,children:e.jsx(t,{...a})}):t(a)}function o(a,i){throw new Error("Expected component `"+a+"` to be defined: you likely forgot to import, pass, or provide it.")}export{l as _markdown,m as default,d as frontmatter,u as structuredData,p as toc};
