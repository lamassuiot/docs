...
`,t={title:"Glosario",description:"Términos de PKI, certificados y gestión de identidades usados en Lamassu."},d={contents:[{heading:"ac",content:`**AKI (Authority Key Identifier)**\\
...
`,"Periodo anterior a la expiración durante el que un dispositivo puede o debe solicitar otra identidad."]}),`
`,e.jsxs(n.p,{children:["¿Falta un término operativo? Consulta primero ",e.jsx(n.a,{href:"/docs/platform/pki/concepts/overview",children:"Cómo funciona Lamassu"})," y el ",e.jsx(n.a,{href:"/docs/platform/pki/concepts/trust-model",children:"Modelo de confianza"}),", donde estos conceptos aparecen conectados."]})]})}function s(i={}){const{wrapper:n}=i.components||{};return n?e.jsx(n,{...i,children:e.jsx(a,{...i})}):a(i)}export{r as _markdown,s as default,t as frontmatter,d as structuredData,c as toc};
