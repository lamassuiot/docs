...
`,e.jsxs(a.p,{children:[e.jsx(a.a,{href:"/docs/platform/pki/quickstarts/register-device",children:"Registra tu primer dispositivo"})," para asociar la identidad a una entidad gestionada, o consulta la ",e.jsx(a.a,{href:"/docs/platform/pki/certificates",children:"gestión de certificados"}),"."]})]})}function m(i={}){const{wrapper:a}=i.components||{};return a?e.jsx(a,{...i,children:e.jsx(d,{...i})}):d(i)}function r(i,a){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{l as _markdown,m as default,o as frontmatter,u as structuredData,p as toc};
