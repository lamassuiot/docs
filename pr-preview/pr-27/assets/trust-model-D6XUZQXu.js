...
`]}),`
`,e.jsxs(a.p,{children:["Continúa con ",e.jsx(a.a,{href:"/docs/platform/pki/ca-hierarchy-and-rotation",children:"Jerarquía y rotación de CAs"})," para convertir este modelo en un procedimiento operativo."]})]})}function u(i={}){const{wrapper:a}=i.components||{};return a?e.jsx(a,{...i,children:e.jsx(o,{...i})}):o(i)}function d(i,a){throw new Error("Expected component `"+i+"` to be defined: you likely forgot to import, pass, or provide it.")}export{t as _markdown,u as default,s as frontmatter,c as structuredData,l as toc};
